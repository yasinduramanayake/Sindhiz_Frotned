          ...
          <b-card no-body class="p-4">
            <b-card-body>
              <b-form @submit="onSubmit">
                ...
                <b-form-group label="Reset Token" label-for="token">
                ...
                <b-form-group label="Confirm password" label-for="confirm_password">
                  <b-form-input id="confirm_password" type="password" v-model.trim="$v.form.confirmPassword.$model" :state="chkState('confirmPassword')" aria-describedby="input1LiveFeedback6" placeholder="Confirm password" autocomplete='new-password' />
