...
export default {
  ...
  beforeMount() {
    this.form.subCategory = {
      label: this.promotion.subcat_name,
      value: this.promotion.subcat
    };
    ...
    this.form.promotiontype = {label: this.promotion.promotiontypename, value: this.promotion.promotiontypeid}
  }
};
</script>
