...
<div className="animated">
  ...
  <div>
    <b-modal ref="modalAddProduct" title="Add Product" hide-footer no-enforce-focus>
        <product-form-add v-if="canShowAddProduct" :isGlobal="true" @success="addProductSuccess" @cancel="cancelAddProduct" />
    </b-modal>
    <b-modal ref="modalEditProduct" title="Edit Product" hide-footer @hide="hideEditProduct" no-enforce-focus>
      <product-form-edit v-if="selectedProduct" isGlobal :product="selectedProduct" @success="editProductSuccess" @cancel="cancelEditProduct" />
    </b-modal>
  </div>
</div>
</template>
...
import GlobalProductActions from './GlobalProductActions'
      ...
      gridOptions: {
        ...
        columnDefs: [{
          ...
          },
          {
            ...
            field: 'productid',
            minWidth: 200,
            cellRendererFramework: 'GlobalProductActions'
          }
        ],
      },
    }
