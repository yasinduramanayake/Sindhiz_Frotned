...
export default {
  ...
  data: function() {
    return {
      ...
      gridOptions: {
        ...
        columnDefs: [
          {headerName: 'Supplier Name', field: 'supplier', filter: 'agTextColumnFilter', minWidth: 120},
          {headerName: 'Sale Sticks', field: 'sales', filter: 'agTextColumnFilter', minWidth: 120},
          {headerName: 'Purchase Sticks', field: 'purchase', filter: 'agTextColumnFilter', minWidth: 120},
          {headerName: 'Sale %', field: 'sales_percent', filter: 'agTextColumnFilter', minWidth: 120},
          {headerName: 'Purchase %', field: 'purchase_percent', filter: 'agTextColumnFilter', minWidth: 120},
        ]
      }
  ...
  methods: {
    exportParams() {
      ...
      return {
        'fileName': 'MerchantPulse_PurchaseReport_'+this.form.store.label+'_'+fromDate+'_'+toDate,
        'columnKeys': ['supplier', 'sales', 'purchase', 'sales_percent', 'purchase_percent']
      }
    },
    gridReady() {
    ...
    onSubmit() {
      if (this.validate()) {
        this.$nextTick(() => {
          ...
          Vue.axios
            .post("/getSalesPurchaseReport", params)
            .then(response => {
