...
export default {
  name: "SalePurchaseByProductReport",
  components: {
    AgGridVue,
    GridButtons
  },
  ...
  data: function() {
    return {
      ...
      gridOptions: {
        ...
        columnDefs: [
          {headerName: 'Product', field: 'prod', filter: 'agTextColumnFilter', minWidth: 120},
          {headerName: 'Cartons Sold', field: 'cartonsSold', filter: 'agTextColumnFilter', minWidth: 100},
          {headerName: 'Sticks Sold', field: 'sticksSold', filter: 'agTextColumnFilter', minWidth: 100},
          {headerName: 'Cartons Purchased', field: 'cartonsPurchased', filter: 'agTextColumnFilter', minWidth: 100},
          {headerName: 'Sticks Purchased', field: 'sticksPurchased', filter: 'agTextColumnFilter', minWidth: 100},
        ]
      }
  ...
  methods: {
    exportParams() {
      ...
      return {
        'fileName': 'MerchantPulse_SalesPurchasedByProductReport_'+this.form.store.label+'_'+fromDate+'_'+toDate,
        'columnKeys': ['prod', 'cartonsSold', 'sticksSold', 'cartonsPurchased', 'sticksPurchased']
      }
    },
    gridReady() {
    ...
    onSubmit() {
      if (this.validate()) {
        this.$nextTick(() => {
          ...
          Vue.axios
            .post("/getSalesPurchaseByProduct", params)
            .then(response => {
