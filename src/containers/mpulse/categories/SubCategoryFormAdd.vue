        ...
        <b-col lg="12">
          ...
          <b-form v-on:submit.prevent="onSubmit" v-on:reset.prevent="onReset" novalidate>
            ...
            <b-form-group label="Sub Category" label-for="subcat">
              <b-form-input id="subcat" type="text" aria-describedby="liveFeedbackSubcat" v-model.lazy.trim="$v.form.subcat.$model" placeholder="Sub Category" />
              <b-form-invalid-feedback id="liveFeedbackSubcat">
                This is a required field.
              </b-form-invalid-feedback>
            </b-form-group>
            <b-form-group label="Sub Category Name" label-for="subcatname">
              <b-form-input id="subcatname" type="text" aria-describedby="liveFeedbackSubcatname" v-model.lazy.trim="$v.form.subcatname.$model" placeholder="Sub Category Name"  />
    ...
    onSubmit() {
      if (this.validate()) {
        this.$nextTick(() => {
          ...
          this.$store.dispatch('categories/addSubCategory', params)
            .then(() => {
              this.$emit('success')
              this.showSuccessMsg()
            })
